...
import { ItalianCurrencyExtractorConfiguration, ItalianCurrencyParserConfiguration } from './italian/currency';
import { ItalianTemperatureExtractorConfiguration, ItalianTemperatureParserConfiguration } from './italian/temperature';
import { ItalianDimensionExtractorConfiguration, ItalianDimensionParserConfiguration } from './italian/dimension';
import { ItalianAgeExtractorConfiguration, ItalianAgeParserConfiguration } from './italian/age';
...
export default class NumberWithUnitRecognizer extends Recognizer<NumberWithUnitOptions> {
    constructor(culture: string, options: NumberWithUnitOptions|number = NumberWithUnitOptions.None, lazyInitialization: boolean = false) {
    ...
    protected InitializeConfiguration() {
        ...
        // #region Italian
        this.registerModel('CurrencyModel', Culture.Italian, (options) => new CurrencyModel(new Map<IExtractor, IParser>([
            [new NumberWithUnitExtractor(new ItalianCurrencyExtractorConfiguration()), new NumberWithUnitParser(new ItalianCurrencyParserConfiguration())],
        ])));
        this.registerModel('TemperatureModel', Culture.Italian, (options) => new TemperatureModel(new Map<IExtractor, IParser>([
            [new NumberWithUnitExtractor(new ItalianTemperatureExtractorConfiguration()), new NumberWithUnitParser(new ItalianTemperatureParserConfiguration())],
        ])));
        this.registerModel('DimensionModel', Culture.Italian, (options) => new DimensionModel(new Map<IExtractor, IParser>([
            [new NumberWithUnitExtractor(new ItalianDimensionExtractorConfiguration()), new NumberWithUnitParser(new ItalianDimensionParserConfiguration())],
        ])));
        this.registerModel('AgeModel', Culture.Italian, (options) => new AgeModel(new Map<IExtractor, IParser>([
            [new NumberWithUnitExtractor(new ItalianAgeExtractorConfiguration()), new NumberWithUnitParser(new ItalianAgeParserConfiguration())],
        ])));
        // #endregion
    ...
    getCurrencyModel(culture: string | null = null, fallbackToDefaultCulture: boolean = true): IModel {
        return this.getModel('CurrencyModel', culture, fallbackToDefaultCulture);
    }

    getTemperatureModel(culture: string | null = null, fallbackToDefaultCulture: boolean = true): IModel {
        return this.getModel('TemperatureModel', culture, fallbackToDefaultCulture);
    }

    getDimensionModel(culture: string | null = null, fallbackToDefaultCulture: boolean = true): IModel {
        return this.getModel('DimensionModel', culture, fallbackToDefaultCulture);
    }

    getAgeModel(culture: string | null = null, fallbackToDefaultCulture: boolean = true): IModel {
