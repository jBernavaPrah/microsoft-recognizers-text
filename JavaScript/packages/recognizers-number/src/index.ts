...
export {
    default as NumberRecognizer, NumberOptions, recognizeNumber, recognizeOrdinal, recognizePercentage,
...
export { ItalianNumeric } from './resources/italianNumeric';
...
export {
    NumberMode, LongFormatType, AbstractNumberModel, NumberModel, OrdinalModel, PercentModel,
} from './number/models';
...
export {
    ItalianNumberExtractor,
    ItalianPercentageExtractor,
    ItalianOrdinalExtractor,
    ItalianCardinalExtractor,
    ItalianDoubleExtractor,
    ItalianFractionExtractor,
    ItalianIntegerExtractor,
} from './number/italian/extractors';
export { ItalianNumberParserConfiguration } from './number/italian/parserConfiguration';
export {
