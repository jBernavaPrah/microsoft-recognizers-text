...
export namespace JapaneseNumeric {
    ...
    export const PercentageSymbol = `(パ\\s*ー\\s*セ\\s*ン\\s*ト|[％%])`;
    ...
    export const NumbersSpecialsCharsWithSuffixAggressive = `(${NegativeNumberTermsRegexNum}?${ZeroToNineFullHalfRegex}+(\\s*${BaseNumbers.NumberMultiplierRegex}+)?)(?=\\b|\\D)`;
    export const NumbersSpecialsChars = `(${NumbersSpecialsCharsAggressive})(?!(([\\.．]${ZeroToNineFullHalfRegex}+)?\\s*${AllMultiplierLookupRegex}))`;
    export const NumbersSpecialsCharsWithSuffix = `(${NumbersSpecialsCharsWithSuffixAggressive})(?!(([\\.．]${ZeroToNineFullHalfRegex}+)?\\s*${AllMultiplierLookupRegex}))`;
    ...
    export const DoubleWithMultiplierAggressiveRegex = `((${NegativeNumberTermsRegexNum}\\s*)?${ZeroToNineFullHalfRegex}+[\\.．]${ZeroToNineFullHalfRegex}+\\s*${BaseNumbers.NumberMultiplierRegex})(?=\\b|\\D)`;
    export const DoubleWithMultiplierRegex = `(${DoubleWithMultiplierAggressiveRegex})(?!${AllMultiplierLookupRegex})`;
    export const DoubleWithThousandsRegex = `((${NegativeNumberTermsRegex}|${NegativeNumberTermsRegexNum})\\s*)?(${ZeroToNineFullHalfRegex}+([\\.．]${ZeroToNineFullHalfRegex}+)?\\s*${RoundNumberIntegerRegex}{1,2})`;
