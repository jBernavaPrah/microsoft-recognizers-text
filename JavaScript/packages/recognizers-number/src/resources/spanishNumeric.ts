...
export namespace SpanishNumeric {
    ...
    export const RelativeReferenceOffsetMap: ReadonlyMap<string, string> = new Map<string, string>([["proxima", "1"],["proximo", "1"],["proximas", "1"],["proximos", "1"],["próxima", "1"],["próximo", "1"],["próximas", "1"],["próximos", "1"],["anterior", "-1"],["anteriores", "-1"],["actual", "0"],["actuales", "0"],["siguiente", "1"],["siguientes", "1"],["ultima", "0"],["ultimo", "0"],["última", "0"],["último", "0"],["ultimas", "0"],["ultimos", "0"],["últimas", "0"],["últimos", "0"],["penultima", "-1"],["penultimo", "-1"],["penúltima", "-1"],["penúltimo", "-1"],["penultimas", "-1"],["penultimos", "-1"],["penúltimas", "-1"],["penúltimos", "-1"],["antepenultima", "-2"],["antepenultimo", "-2"],["antepenúltima", "-2"],["antepenúltimo", "-2"],["antepenultimas", "-2"],["antepenultimos", "-2"],["antepenúltimas", "-2"],["antepenúltimos", "-2"],["antes de la ultima", "-1"],["antes del ultimo", "-1"],["antes de la última", "-1"],["antes del último", "-1"],["anterior al ultimo", "-1"],["anterior a la ultima", "-1"],["anterior al último", "-1"],["anterior a la última", "-1"]]);
