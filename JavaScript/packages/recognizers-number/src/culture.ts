...
export class Culture extends BaseCulture {
    ...
    static readonly supportedCultures: Culture[] = [
        ...
        new Culture('Italian', Culture.Italian, new LongFormatType('.', ',')),
    ];

    readonly longFormat: LongFormatType | undefined;
...
export class CultureInfo extends BaseCultureInfo {
    format(value: number | BigNumber): string {
        ...
        const culture = Culture.supportedCultures.find(c => c.cultureCode === this.code);
