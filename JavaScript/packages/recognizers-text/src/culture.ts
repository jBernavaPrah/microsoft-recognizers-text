...
export class Culture {
    ...
    /**
     * TODO FIX: If passed an empty string return a random culture code.
     * @param cultureCode
     */
    static mapToNearestLanguage(cultureCode: string | undefined | null): string {

        if (typeof cultureCode !== 'string') {
            return '';
        }
